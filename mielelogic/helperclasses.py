...
class TimeTable(object):
    ...
    def get_available_time_slots(self, start_time=None, end_time=None):
            ...
            if "T" in start_time.upper():
                ...
                try:
                    ...
                    start_time = datetime.strptime(
                        start_time, ALT_DATEFORMAT_NO_SECONDS
                    )
        ...
        if start_time is None and end_time is None:
            ...
            return [
                x for x in self.time_table if x.available and x.end_time <= end_time
            ]
        elif end_time is None:
            return [
                x for x in self.time_table if x.available and x.start_time >= start_time
            ]
        else:
            return [
                x
                for x in self.time_table
                if x.available and x.start_time >= start_time and x.end_time <= end_time
            ]
